  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <Form>
            <FormItem {...formItemLayout} label="集群显示名:">
              <Input
                onChange={this.onClusterInfoChange.bind(this, 'name')}
                value={this.state.info.name}
                placeholder="请填写集群显示名"
              />
            </FormItem>
            <FormItem {...formItemLayout} label="集群Code:">
              <Input
                onChange={this.onClusterInfoChange.bind(this, 'code')}
                value={this.state.info.code}
                placeholder="请填写集群Code，英文字母"
              />
            </FormItem>
            <FormItem {...formItemLayout} label="endpoint:">
              <Input
                onChange={this.onClusterInfoChange.bind(this, 'endpoint')}
                value={this.state.info.endpoint}
                placeholder="集群中任意一台机器都可以, 格式: 'http://$ip:9999'"
              />
            </FormItem>
            ...
            <FormItem {...formItemLayout} label="集群环境">
              <Select
                defaultValue={this.state.info.env}
